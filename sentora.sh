...
if [[ "$OS" = "CentOs" || "$OS" = "Fedora" ]]; then
	...
	if [[ "$VER" == "18.04" ]]; then
		$PACKAGE_INSTALLER php5.6 libapache2-mod-php5.6 php5.6-mcrypt php5.6-mbstring php5.6-curl php5.6-cli php5.6-mysql php5.6-gd php5.6-intl php5.6-xsl php5.6-soap php5.6-dom php5.6-json php5.6-common php5.6-readline php5.6-dev php5.6-fpm php5.6-zip
	else
